...
namespace TfsCmdlets.SourceGenerators
{
    ...
    public class CmdletGenerator : ISourceGenerator
    {
        ...
        private readonly List<(Func<CmdletInfo, bool>, Func<CmdletInfo, string>)> _generators =
            new List<(Func<CmdletInfo, bool>, Func<CmdletInfo, string>)>();
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var type in syntaxReceiver.Cmdlets)
            {
                ...
                context.AddSource($"{type.FullName()}.cs", SourceText.From($@"/*
...
";
        ...
        private class CmdletInfo
        {
            ...
            internal string PipelineProperty { get; private set; }
            ...
            internal CmdletInfo(INamedTypeSymbol cmdlet)
            {
                ...
                Noun = cmdlet.Name.Substring(GetAttributeConstructorValue<string>(cmdlet, "CmdletAttribute").Length);
