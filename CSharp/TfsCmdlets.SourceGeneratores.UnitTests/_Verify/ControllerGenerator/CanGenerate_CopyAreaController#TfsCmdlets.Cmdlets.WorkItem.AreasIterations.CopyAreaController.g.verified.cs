...
{
    internal partial class CopyAreaController: CopyClassificationNodeController
    {
        // Node
        ...
        public CopyAreaController(IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
