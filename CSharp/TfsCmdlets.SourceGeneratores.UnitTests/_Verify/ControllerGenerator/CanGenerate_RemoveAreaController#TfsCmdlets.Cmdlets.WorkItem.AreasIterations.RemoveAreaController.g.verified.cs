...
{
    internal partial class RemoveAreaController: RemoveClassificationNodeController
    {
        // Node
        ...
        public RemoveAreaController(IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger, IWorkItemTrackingHttpClient client)
