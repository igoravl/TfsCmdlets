//HintName: TfsCmdlets.Cmdlets.Pipeline.Build.Definition.ResumeBuildDefinitionController.g.cs
using System.Management.Automation;
using Microsoft.TeamFoundation.Build.WebApi;
namespace TfsCmdlets.Cmdlets.Pipeline.Build.Definition
{
    internal partial class ResumeBuildDefinitionController: ControllerBase
    {
        ...
        public ResumeBuildDefinitionController(TfsCmdlets.HttpClients.IBuildHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
