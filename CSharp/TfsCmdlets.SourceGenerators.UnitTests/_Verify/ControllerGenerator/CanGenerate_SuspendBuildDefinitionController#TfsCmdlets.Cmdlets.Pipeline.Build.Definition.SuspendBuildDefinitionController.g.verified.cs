//HintName: TfsCmdlets.Cmdlets.Pipeline.Build.Definition.SuspendBuildDefinitionController.g.cs
using System.Management.Automation;
using Microsoft.TeamFoundation.Build.WebApi;
namespace TfsCmdlets.Cmdlets.Pipeline.Build.Definition
{
    internal partial class SuspendBuildDefinitionController: ControllerBase
    {
        ...
        public SuspendBuildDefinitionController(TfsCmdlets.HttpClients.IBuildHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
