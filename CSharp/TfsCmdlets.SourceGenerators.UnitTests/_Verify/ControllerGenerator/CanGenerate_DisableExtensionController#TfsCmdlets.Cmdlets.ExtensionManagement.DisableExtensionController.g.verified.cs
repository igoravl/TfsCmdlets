...
namespace TfsCmdlets.Cmdlets.ExtensionManagement
{
    internal partial class DisableExtensionController: ControllerBase
    {
        ...
        public DisableExtensionController(TfsCmdlets.HttpClients.IExtensionManagementHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
