...
namespace TfsCmdlets.Cmdlets.Git
{
    internal partial class RemoveGitRepositoryController: ControllerBase
    {
        ...
        public RemoveGitRepositoryController(TfsCmdlets.HttpClients.IGitHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
