...
{
    internal partial class MoveAreaController: MoveClassificationNodeController
    {
        // Node
        ...
        public MoveAreaController(IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger, IWorkItemTrackingHttpClient client)
