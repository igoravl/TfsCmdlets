...
namespace TfsCmdlets.Cmdlets.Admin
{
    ...
    {
        // ComputerName
        protected bool Has_ComputerName => Parameters.HasParameter(nameof(ComputerName));
        protected IEnumerable ComputerName
        {
            get
            {
                var paramValue = Parameters.Get<object>(nameof(ComputerName), "localhost");
