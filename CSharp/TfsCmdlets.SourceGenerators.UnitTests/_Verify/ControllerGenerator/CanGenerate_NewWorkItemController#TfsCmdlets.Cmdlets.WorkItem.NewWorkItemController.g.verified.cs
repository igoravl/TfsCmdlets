//HintName: TfsCmdlets.Cmdlets.WorkItem.NewWorkItemController.g.cs
...
namespace TfsCmdlets.Cmdlets.WorkItem
{
    internal partial class NewWorkItemController: ControllerBase
    {
        ...
        // Items
        protected IEnumerable<Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItem> Items => Type switch {
        ...
        protected override void CacheParameters()
        {
            ...
            Type = Parameters.Get<object>("Type");
            // Title
        ...
        public NewWorkItemController(IWorkItemPatchBuilder builder, TfsCmdlets.HttpClients.IWorkItemTrackingHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
