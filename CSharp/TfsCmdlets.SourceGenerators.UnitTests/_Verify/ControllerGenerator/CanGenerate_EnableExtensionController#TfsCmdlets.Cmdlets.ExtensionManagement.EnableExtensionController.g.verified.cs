//HintName: TfsCmdlets.Cmdlets.ExtensionManagement.EnableExtensionController.g.cs
using System.Management.Automation;
using Microsoft.VisualStudio.Services.ExtensionManagement.WebApi;
namespace TfsCmdlets.Cmdlets.ExtensionManagement
{
    internal partial class EnableExtensionController: ControllerBase
    {
        ...
        public EnableExtensionController(TfsCmdlets.HttpClients.IExtensionManagementHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
