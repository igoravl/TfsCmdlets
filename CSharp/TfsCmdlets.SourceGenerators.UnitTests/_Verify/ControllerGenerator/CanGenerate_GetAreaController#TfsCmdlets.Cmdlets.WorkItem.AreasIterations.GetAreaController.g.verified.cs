...
{
    internal partial class GetAreaController: ControllerBase
    {
        ...
        public GetAreaController(INodeUtil nodeUtil, TfsCmdlets.HttpClients.IWorkItemTrackingHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
