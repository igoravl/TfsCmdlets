...
namespace TfsCmdlets.Cmdlets.Git
{
    internal partial class GetGitRepositoryController: ControllerBase
    {
        ...
        public GetGitRepositoryController(TfsCmdlets.HttpClients.IGitHttpClient client, IPowerShellService powerShell, IDataManager data, IParameterManager parameters, ILogger logger)
