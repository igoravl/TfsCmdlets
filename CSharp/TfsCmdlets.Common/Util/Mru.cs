namespace TfsCmdlets.Util
{
    ...
    //    public static Mru Server { get; } = Create(nameof(Server));

    //    public static Mru Collection { get; } = Create(nameof(Collection));

    //    public static Mru Create(string listName, int capacity = 10)
    //    {
    ...
    public static class MruListExtensions
    {
