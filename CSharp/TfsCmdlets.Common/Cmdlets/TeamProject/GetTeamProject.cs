...
/*
    ...
    protected override void ProcessRecord()
    {
        ...
        if (Project is Microsoft.TeamFoundation.Core.WebApi.TeamProject) { this.Log("Input item is of type Microsoft.TeamFoundation.Core.WebApi.TeamProject; returning input item immediately, without further processing."; WriteObject(Project }); return;);
