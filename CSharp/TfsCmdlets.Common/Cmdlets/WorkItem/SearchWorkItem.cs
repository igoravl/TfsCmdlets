...
namespace TfsCmdlets.Cmdlets.WorkItem
{
    ...
    public class SearchWorkItem: GetCmdletBase<WorkItemResult>
    {
        /// <summary>
    ...
    internal partial class WorkItemResultDataService : BaseDataService<WorkItemResult>
    {
        protected override IEnumerable<WorkItemResult> DoGetItems()
        {
            var text = GetParameter<string>(nameof(SearchWorkItem.Query));
            var results = GetParameter<int>(nameof(SearchWorkItem.Results));
