...
namespace TfsCmdlets.Cmdlets.WorkItem.AreasIterations
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Move, "TfsArea", ConfirmImpact = ConfirmImpact.Medium, SupportsShouldProcess = true)]
    ...
    /// </example>
    [Cmdlet(VerbsCommon.Move, "TfsIteration", ConfirmImpact = ConfirmImpact.Medium, SupportsShouldProcess = true)]
    [OutputType(typeof(WorkItemClassificationNode))]
