...
namespace TfsCmdlets.Cmdlets.Work
{
    ...
    public class GetTeamBacklog: PSCmdlet
    {
/*
    ...
    {
        if (Backlog is Microsoft.TeamFoundation.Work.WebApi.BacklogLevelConfiguration) { _Log "Input item is of type Microsoft.TeamFoundation.Work.WebApi.BacklogLevelConfiguration; returning input item immediately, without further processing."; WriteObject(Backlog }); return;
