...
namespace TfsCmdlets.Cmdlets.Policy
{
    ...
    public class GetPolicyType: PSCmdlet
    {
/*
        [Parameter()]
        [SupportsWildcards()]
    ...
    {
        if (Type is Microsoft.TeamFoundation.Policy.WebApi.PolicyType) { _Log "Input item is of type Microsoft.TeamFoundation.Policy.WebApi.PolicyType; returning input item immediately, without further processing."; WriteObject(Type }); return;
