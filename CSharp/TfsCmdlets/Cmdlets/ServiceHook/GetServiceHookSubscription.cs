...
namespace TfsCmdlets.Cmdlets.ServiceHook
{
    ...
    public class GetServiceHookSubscription : GetCmdletBase<WebApiSubscription>
    {
        /// <summary>
    ...
    internal partial class ServiceHookSubscriptionDataService : BaseDataService<WebApiSubscription>
    {
