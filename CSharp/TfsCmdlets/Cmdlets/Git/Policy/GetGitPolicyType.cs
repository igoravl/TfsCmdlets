...
namespace TfsCmdlets.Cmdlets.Git.Policy
{
    ...
    //internal class PolicyTypeDataServiceImpl : CollectionLevelController<PolicyType>
    //{
    //    protected override IEnumerable<PolicyType> DoGetItems(ParameterDictionary parameters)
    //    {
