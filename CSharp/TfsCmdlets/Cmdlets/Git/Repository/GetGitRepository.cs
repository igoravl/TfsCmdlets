...
namespace TfsCmdlets.Cmdlets.Git.Repository
{
    ...
    public class GetGitRepository: PSCmdlet
    {
/*
    ...
    {
        if (Repository is Microsoft.TeamFoundation.SourceControl.WebApi.GitRepository) { _Log "Input item is of type Microsoft.TeamFoundation.SourceControl.WebApi.GitRepository; returning input item immediately, without further processing."; WriteObject(Repository }); return;
