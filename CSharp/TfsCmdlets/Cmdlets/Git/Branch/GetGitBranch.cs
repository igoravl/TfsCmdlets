...
namespace TfsCmdlets.Cmdlets.Git.Branch
{
    ...
    //internal partial class GitBranchStatsDataServiceImpl : CollectionLevelController<GitBranchStats>
    //{
    //    protected override IEnumerable<GitBranchStats> DoGetItems(ParameterDictionary parameters)
    //    {
