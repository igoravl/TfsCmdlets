...
namespace TfsCmdlets.Cmdlets.WorkItem.AreasIterations
{
    ...
    /// </summary>
    public abstract class NewClassificationNode : CmdletBase
    {
        /// <summary>
    ...
    //    {
    //        var node = parameters.Get<string>(nameof(NewClassificationNode.Node));
    //        var structureGroup = parameters.Get<TreeStructureGroup>("StructureGroup");
    //        var force = parameters.Get<bool>(nameof(NewClassificationNode.Force));
    ...
    //        if (!PowerShell.ShouldProcess($"Team Project {tp.Name}", $"Create node '{nodePath}'")) return null;
    ...
    //            var startDate = parameters.Get<DateTime?>(nameof(SetIteration.StartDate));
    //            var finishDate = parameters.Get<DateTime?>(nameof(SetIteration.FinishDate));
