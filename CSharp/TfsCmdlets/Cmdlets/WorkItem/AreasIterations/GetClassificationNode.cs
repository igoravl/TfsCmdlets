...
namespace TfsCmdlets.Cmdlets.WorkItem.AreasIterations
{
    ...
    //internal partial class ClassificationNodeDataService : CollectionLevelController<ClassificationNode>
    //{
    //    protected override IEnumerable<ClassificationNode> DoGetItems()
    //    {
    //        var node = parameters.Get<object>(nameof(GetClassificationNode.Node));
