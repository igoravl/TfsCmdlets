...
namespace TfsCmdlets.Cmdlets.WorkItem.Tagging
{
    ...
    public class GetWorkItemTag: PSCmdlet
    {
/*
    ...
    {
        if (Tag is Microsoft.TeamFoundation.Core.WebApi.WebApiTagDefinition) { _Log "Input item is of type Microsoft.TeamFoundation.Core.WebApi.WebApiTagDefinition; returning input item immediately, without further processing."; WriteObject(Tag }); return;
