...
namespace TfsCmdlets.Cmdlets.WorkItem.ClassificationNode
{
    ...
    public class GetClassificationNode: PSCmdlet
    {
/*
        [Parameter()]
        [SupportsWildcards()]
    ...
    {
        if (Node is Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemClassificationNode) { _Log "Input item is of type Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemClassificationNode; returning input item immediately, without further processing."; WriteObject(Node }); return;
