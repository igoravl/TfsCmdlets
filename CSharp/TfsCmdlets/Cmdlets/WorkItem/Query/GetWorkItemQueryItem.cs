...
namespace TfsCmdlets.Cmdlets.WorkItem.Query
{
    ...
    public class GetWorkItemQueryItem: PSCmdlet
    {
/*
...
// TODO: Remover espaço antes de /
    ...
    {
        if (Item is Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.QueryHierarchyItem) { _Log "Input item is of type Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.QueryHierarchyItem; returning input item immediately, without further processing."; WriteObject(Item }); return;
