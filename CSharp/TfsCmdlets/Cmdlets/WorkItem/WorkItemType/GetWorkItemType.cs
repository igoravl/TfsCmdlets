...
namespace TfsCmdlets.Cmdlets.WorkItem.WorkItemType
{
    ...
    public class GetWorkItemType : GetCmdletBase<WebApiWorkItemType>
    {
        /// <summary>
    ...
    internal partial class WorkItemTypeDataService : BaseDataService<WebApiWorkItemType>
    {
        protected override IEnumerable<WebApiWorkItemType> DoGetItems()
        {
            var type = GetParameter<object>(nameof(GetWorkItemType.Type));

            if (HasParameter(nameof(GetWorkItemType.WorkItem)))
            {
                var workItem = GetItem<WebApiWorkItem>(nameof(GetWorkItemType.WorkItem));
