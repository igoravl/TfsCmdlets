...
namespace TfsCmdlets.Cmdlets.Identity
{
    ...
    public class GetIdentity: PSCmdlet
    {
/*
    ...
    protected override void ProcessRecord()
    {
        ...
        {
            if (Identity is Microsoft.VisualStudio.Services.Identity.Identity) { _Log "Input item is of type Microsoft.VisualStudio.Services.Identity.Identity; returning input item immediately, without further processing."; WriteObject(Identity }); return;
            _GetServer
        }
