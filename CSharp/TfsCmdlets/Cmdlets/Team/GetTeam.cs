...
/*
    ...
    protected override void ProcessRecord()
    {
        ...
        if (Team is Microsoft.TeamFoundation.Core.WebApi.WebApiTeam) { _Log "Input item is of type Microsoft.TeamFoundation.Core.WebApi.WebApiTeam; returning input item immediately, without further processing."; WriteObject(Team }); return;
