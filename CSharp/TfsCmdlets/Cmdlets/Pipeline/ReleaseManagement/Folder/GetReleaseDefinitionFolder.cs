...
namespace TfsCmdlets.Cmdlets.Pipeline.ReleaseManagement.Folder
{
    ...
    public class GetReleaseDefinitionFolder: PSCmdlet
    {
/*
    ...
    {
        if (Folder is Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.Folder) { _Log "Input item is of type Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.Folder; returning input item immediately, without further processing."; WriteObject(Folder }); return;
