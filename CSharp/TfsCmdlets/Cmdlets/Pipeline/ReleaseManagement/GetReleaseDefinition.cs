...
namespace TfsCmdlets.Cmdlets.Pipeline.ReleaseManagement
{
    ...
    public class GetReleaseDefinition: PSCmdlet
    {
/*
    ...
    {
        if (Definition is Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.ReleaseDefinition) { _Log "Input item is of type Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.ReleaseDefinition; returning input item immediately, without further processing."; WriteObject(Definition }); return;
