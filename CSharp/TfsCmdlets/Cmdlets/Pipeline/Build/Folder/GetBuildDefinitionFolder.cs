...
namespace TfsCmdlets.Cmdlets.Pipeline.Build.Folder
{
    ...
    public class GetBuildDefinitionFolder: PSCmdlet
    {
/*
    ...
    {
        if (Folder is Microsoft.TeamFoundation.Build.WebApi.Folder) { _Log "Input item is of type Microsoft.TeamFoundation.Build.WebApi.Folder; returning input item immediately, without further processing."; WriteObject(Folder }); return;
