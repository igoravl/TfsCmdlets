    ...
    internal class EnterShell : CommandBase
    {
        ...
        public override object InvokeCommand(ParameterDictionary parameters)
        {
            ...
            if (!noLogo)
            {
                ...
                PowerShell.WriteObject($"Version {privateData["Build"]}");
                PowerShell.WriteObject($"Azure DevOps Client Library version {privateData["TfsClientVersion"]}");
            }
