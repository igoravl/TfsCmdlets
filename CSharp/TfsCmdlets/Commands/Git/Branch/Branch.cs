...
{
    [Command]
    internal class GetGitBranch : CommandBase<GitBranchStats>
    {
        public override IEnumerable<GitBranchStats> Invoke(ParameterDictionary parameters)
        {
        ...
        public GetGitBranch(IPowerShellService powerShell, IConnectionManager connections, IDataManager data, ILogger logger) 
