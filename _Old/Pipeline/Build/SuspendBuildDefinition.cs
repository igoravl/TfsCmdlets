...
namespace TfsCmdlets.Cmdlets.Pipeline.Build
{
    ...
    public class SuspendBuildDefinition : SuspendCmdletBase<BuildDefinition>
    {
        /// <summary>
    ...
    partial class BuildDefinitionDataService
    {
        protected override BuildDefinition DoSuspendItem()
        {
            ...
            if (!ShouldProcess(def.Project.Name, $"Pause Build Definition '{def.GetFullPath()}'")) return def;
