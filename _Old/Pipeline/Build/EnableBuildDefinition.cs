...
namespace TfsCmdlets.Cmdlets.Pipeline.Build
{
    ...
    public class EnableBuildDefinition : EnableCmdletBase<BuildDefinition>
    {
        /// <summary>
    ...
    partial class BuildDefinitionDataService
    {
        protected override BuildDefinition DoEnableItem()
        {
            ...
            if (!ShouldProcess(def.Project.Name, $"Enable Build Definition '{def.GetFullPath()}'")) return def;
