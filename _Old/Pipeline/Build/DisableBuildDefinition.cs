...
namespace TfsCmdlets.Cmdlets.Pipeline.Build
{
    ...
    public class DisableBuildDefinition : DisableCmdletBase<BuildDefinition>
    {
        /// <summary>
    ...
    partial class BuildDefinitionDataService
    {
        protected override BuildDefinition DoDisableItem()
        {
            ...
            if (!ShouldProcess(def.Project.Name, $"Disable Build Definition '{def.GetFullPath()}'")) return def;
