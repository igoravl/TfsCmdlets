...
parameterSets: 
  "_All_": [ AzureLogin, Cached, Collection, Credential, Interactive, Passthru, Password, PersonalAccessToken, Server, UserName ] 
  "Cached credentials":  
    Collection: 
      type: "object"  
      position: "0"  
...
parameters: 
  ...
  - name: "Organization" 
    description: "Specifies the URL to the Team Project Collection or Azure DevOps Organization to connect to, a TfsTeamProjectCollection object (Windows PowerShell only), or a VssConnection object. You can also connect to an Azure DevOps Services organizations by simply providing its name instead of the full URL. This is an alias of the Collection parameter." 
    required: true 
    globbing: false 
    pipelineInput: "true (ByValue)" 
    position: 0 
...
relatedLinks: 
  - text: "Online Version:" 
    uri: "https://tfscmdlets.dev/docs/cmdlets/TeamProjectCollection/Connect-TfsTeamProjectCollection"
aliases: 
examples: 
  - title: "----------  EXAMPLE 1  ----------" 
