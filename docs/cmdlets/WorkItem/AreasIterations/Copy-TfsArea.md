...
description: "Copies one or more Work Item Areas recursively "
remarks: 
parameterSets: 
...
parameters: 
  ...
  - name: "DestinationProject" 
    description: "Specifies the name and/or path of the destination team project. When omitted, copies the area to the same team project. " 
    globbing: false 
    type: "object" 
  - name: "Force" 
...
relatedLinks: 
  - text: "Online Version:" 
    uri: "https://tfscmdlets.dev/docs/cmdlets/WorkItem/AreasIterations/Copy-TfsArea"
aliases: 
examples: 
---
