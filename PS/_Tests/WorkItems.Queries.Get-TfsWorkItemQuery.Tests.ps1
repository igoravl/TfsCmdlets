    ...
    Context 'Integration Tests' {
        ...
        It 'Should get all queries' {
            ...
            (Get-TfsWorkItemQuery).Path | Sort-Object | Should -Be @(
                ...
                "Shared Queries/Dashboard Queries/All bugs", 
        ...
        It 'Should get queries by name' {
            ...
            (Get-TfsWorkItemQuery 'Assigned to me').Path | Should -Be "My Queries/Personal Queries/Assigned to me"
            (Get-TfsWorkItemQuery 'Unfinished Work_WI').Path | Should -Be "Shared Queries/Team Queries/Team1 Queries/Unfinished Work_WI"
